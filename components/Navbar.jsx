      ...
      loading="lazy" /> */}
            ...
            <ul className="navbar-nav flex flex-col pl-0 list-style-none mr-auto">
              <li className="nav-item p-2">
                ...
                <a className="nav-link text-gray-500 hover:text-blue-700 focus:text-gray-700 p-0" href="#">Dashboard</a>
                
              </li>
              <li className="nav-item p-2">
        
                <a className="nav-link text-gray-500 hover:text-blue-700 focus:text-gray-700 p-0" href="#">Material UI</a>
          ...
          <div className="flex items-center relative">
            ...
            <a className="text-black hover:text-blue-700 focus:text-gray-700 mr-4" href="#">
